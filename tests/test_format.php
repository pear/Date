...
compare('Thu', $date->format('%a'), '%');
compare('Thursday', $date->format('%A'), '%');
compare('Nov', $date->format('%b'), '%');
compare('November', $date->format('%B'), '%');
compare('20', $date->format('%C'), '%');
compare('29', $date->format('%d'), '%');
compare('11/29/2007', $date->format('%D'), '%');
compare('29', $date->format('%e'), '%');
compare('2454434', $date->format('%E'), '%');
compare('23', $date->format('%h'), '%');
compare('23', $date->format('%H'), '%');
compare('11', $date->format('%i'), '%');
compare('11', $date->format('%I'), '%');
compare('333', $date->format('%j'), '%');
compare('11', $date->format('%m'), '%');
compare('13', $date->format('%M'), '%');
compare("\n", $date->format('%n'), '%');
compare('+01:00', $date->format('%o'), '%');
compare('+01:00', $date->format('%O'), '%');
compare('pm', $date->format('%p'), '%');
compare('PM', $date->format('%P'), '%');
compare('11:13:46 PM', $date->format('%r'), '%');
compare('23:13', $date->format('%R'), '%');
compare('46.090020', $date->format('%s'), '%');
compare('46', $date->format('%S'), '%');
compare("\t", $date->format('%t'), '%');
compare('23:13:46', $date->format('%T'), '%');
compare('48', $date->format('%U'), '%');
compare('4', $date->format('%w'), '%');
compare('07', $date->format('%y'), '%');
compare('2007', $date->format('%Y'), '%');
compare('CET', $date->format('%Z'), '%');
compare('%', $date->format('%%'), '%%');
...
compare('UTC', $date3->format2('TZC'), 'TZC (3)');
compare('00', $date3->format2('TZH'), 'TZH (3)');
compare('+00', $date3->format2('STZH'), 'STZH (3)');
compare('0', $date3->format2('NPTZH'), 'NPTZH (3)');
compare('+0', $date3->format2('NPSTZH'), 'NPSTZH (3)');
compare('ZERO', $date3->format2('NPTZHSP'), 'NPTZHSP (3)');
compare('+ZEROTH', $date3->format2('NPSTZHSPTH'), 'NPSTZHSPTH (3)');
compare('0', $date3->format2('TZI'), 'TZI (3)');
compare('00', $date3->format2('TZM'), 'TZM (3)');
compare('0', $date3->format2('NPTZM'), 'NPTZM (3)');
compare('Coordinated Universal Time', $date3->format2('TZN'), 'TZN (3)');
compare('00000', $date3->format2('TZS'), 'TZS (3)');
compare(' 00000', $date3->format2('STZS'), 'STZS (3)');
compare('0', $date3->format2('NPTZS'), 'NPTZS (3)');
compare('0', $date3->format2('NPSTZS'), 'NPSTZS (3)');
compare('zero', $date3->format2('TZSsp'), 'NPSTZSsp (3)');
compare('Zero', $date3->format2('NPSTZSSp'), 'NPSTZSSp (3)');
compare('Z     ', $date3->format2('TZO'), 'TZO (3)');
compare('Z', $date3->format2('NPTZO'), 'NPTZO (3)');
compare('UTC', $date3->format2('TZR'), 'TZR (3)');
